...
Hi.Time = function () {
    ...
    var e = new Hi.Map,
        ...
        n = function (data) {
            //if(data!=0){
            $.post('http://newyearp.feeyo.com/socket.php', {cmd: data}, function (ref) {
                if (ref.code == 1) {
                    if (!empty(ref.data)) {
                        t($.base64.atob(ref.data, !0));
                    }
                } else if (ref.code == 0) {
                    setTimeout(function () {
                        n(0)
                    ...
                    if (!empty(ref.data)) {
                        var len = ref.data.length;
                        for (var i = 0; i < len; i++) {
                            t($.base64.atob(ref.data[i], !0));
                        }
                    }
                    setTimeout(function () {
                        n(1)
