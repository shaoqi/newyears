...
            o.type = "text/javascript", o.src = t, document.getElementsByTagName("body")[0].appendChild(o), o.onload =
                o.onreadystatechange = function () {
                this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (o.onload = o.onreadystatechange =
                    null, n && n())
            }, o.onerror = function () {
                n && n()
            }
...
                        if (!isNaN(parseInt(e))) {
                            var t = i[e],
                                n = r.transaction(t).objectStore(t),
                                o = n.indexNames,
                                l = [];
...
                a = function () {
                    var e = $.Deferred();
                    return r[t] && !r[t].table[n] ? (Hi.Db.deleteDb(t).then(e.resolve, e.reject), console.log(
                        "checkDbTables delete Hi")) : e.resolve(), e.promise()
                }, l = function () {
                    console.log("clearExpire");
                    var e = $.Deferred(),
                        r = $.indexedDB(t, o).objectStore(n, "readonly");
                    return r.each(function (e) {
                        if (e.key != flag) {
                            var t = e.value,
                                n = parseInt(t.createTime);
...
                        }
                    }), o ? (Hi.Db.deleteDb(flag).then(t.resolve, t.reject), console.log("checkDbTables delete", flag)) :
                        t.resolve(), t.promise()
                };
...
    function e() {
        this.dom = $("#wallcopyright"), this.moveDom = $(".sponer-order"), this.parentW = parseInt(this.moveDom.parents()
            .outerWidth()), this.oncespeed = 2e4, this.limit = this.dom.outerWidth(), this.moveDomW = 0, this.moveTime =
            0, this.edgeGap = (this.limit - this.parentW) / 2, this.isPlay = !1, this.playStart = !1, this.upStart = !1,
            this.init()
    }
    return e.prototype = {
        init: function () {
...
            }), e > this.parentW ? (this.moveDom.css("width", e + "px"), this.moveDomW = e, this.isPlay = !0) : (this.moveDom
                .css("width", "auto"), this.isPlay = !1), this.upStart = !1, this.calculTime()
        },
        calculTime: function () {
...
        animate: function () {
            var e = this;
            this.upStart && this.calcul(), this.isPlay ? (this.playStart = !0, this.moveDom.animate({
                left: -(e.moveDomW + e.edgeGap) + "px"
            }, e.moveTime, function () {
...
                    e = !1
                });
            var t = messageArr.shift(),
                n = '<i class="fa fa-volume-up"></i>  ' + t.content;
...
        var e = this,
            t = $.Deferred(),
            n = $.indexedDB(e.dbName).objectStore(e.tableName, "readonly");
...
        var e = $.Deferred(),
            t = $.indexedDB(this.dbName).objectStore(this.tableName);
...
            n = function () {
                var e = $.Deferred(),
                    n = $.indexedDB(t.dbName).objectStore(t.tableName);
                return n.count().always(function (t) {
                    e.resolve(t)
                }), e.promise()
            }, o = function (e) {
                var t = $.Deferred(),
                    n = $.indexedDB(this.dbName).objectStore(this.tableName),
                    o = 0;
...
                        var c = l.objectStore(t.tableName),
                            u = function () {
                                var n = $.Deferred();
                                return o && i ? (o[0].prev = e.data.seq, e.next = o[0].data.seq, Hi.Recurse.data(o, function (
                                    e, n) {
...
                            i && e.data.seq && c.put(e, e.data.seq), new Hi.DbUtil(flag, "keyvalue").update(t.tableName +
                                "_maxseq", s)
                        }).always(n.resolve)
                    })
                } else n.resolve();
...
        var t = this,
            n = $.Deferred(),
            o = $.indexedDB(t.dbName).objectStore(t.tableName, "readonly");
...
        var n = this,
            o = $.Deferred(),
            r = $.indexedDB(n.dbName).objectStore(n.tableName);
...
        var t = this,
            n = $.Deferred(),
            o = $.indexedDB(t.dbName).objectStore(t.tableName);
...
                if (e && e.length) {
                    var o = e[e.length - 1];
                    o.next ? (l = "next" == t ? e[e.length - 1] : e[0], n.resolve()) : new Hi.DbUtil(flag, i.tableName)
                        .get(o.data.seq).then(function (n) {
...
            }, c = function () {
                var e = $.Deferred(),
                    r = $.indexedDB(i.dbName).objectStore(i.tableName),
                    s = function () {
                        var i = null;
                        i = "next" != t || 0 != l.next || l.data.seq ? "prev" != t || 0 != l.prev || l.data.seq ? r.index(
                            "data.seq") : r.index("next") : r.index("prev"), i.get(l[t]).then(function (t) {
...
            var e = $.Deferred(),
                t = this,
                n = new Hi.DbUtil(this.Hi, this.Hi);
...
            var t = $.Deferred(),
                n = this,
                o = new Hi.DbUtil(this.Hi, this.Hi);
...
            var e = $.Deferred(),
                t = this,
                n = new Hi.DbUtil(flag, t.modelName),
                o = new Hi.DbUtil(flag, "keyvalue"),
                r = function () {
                    var e = $.Deferred();
...
                t || (t = 0), e ? (e.maxSeq = t, n.resolve(e)) : n.resolve({
                    maxSeq: t
                })
            }, function () {
                n.reject("查询最大seq错误")
...
                where: {}
            };
            return n && (i.where.v = n, o && (i.where.seq = o)), Hi.Dc.query(i).page(0, 5e3).post(t.config.syncUrl, function (
                o, i) {
                if (o) return console.log(o), void r.reject();
                var a = i.data ? i.data.length : 0,
                    l = function (e) {
                        var n = i.data;
...
                }, u = function (e) {
                    var n = $.Deferred();
                    return e && e.length ? Hi.Dc.query({
                        where: {
                            seqList: e
                        }
                    }).post(t.config.seqUrl, function (o, r) {
                        return o ? void n.reject({
                            msg: "补充数据失败",
                            misArr: e
...
                        return e.data.seq - t.data.seq
                    });
                    var c = n.length; !! n.length;
                    return console.log("入库数据", t.config.tableName, n.length), new Hi.DbUtil(flag, t.config.tableName).dealArr(
                        n).then(function () {
...
                    }))
                };
            return clearInterval(e.control.timer), e.control.timer = setInterval(n, 2e3),
            function () {
                clearInterval(timer)
            }
        },
...
                t = this,
                n = 0;
            if (t.goFlag[t.modelName]) setTimeout(e.resolve, 500);
            else {
                t.goFlag[t.modelName] = !0;
                var o = function () {
                    return ++n, n > 10 ? void e.resolve() : void t.getVersion().then(t.getMaxSeq.bind(t)).then(t.sync.bind(
                        t)).always(function (n) {
...
                    }))
                };
            return clearInterval(e.control.timerSocket), e.control.timerSocket = setInterval(n, 5e3),
            function () {
...
        }, o = function () {
            n().css("animation-play-state", "running"), $("#playPause i").last().removeClass("hi-plays").addClass(
                "hi-suspend")
        }, r = function () {
            n().css("animation-play-state", "paused"), $("#playPause i").last().removeClass("hi-suspend").addClass(
                "hi-plays")
        }, i = function () {
            n().removeClass("play")
        }, a = function () {
...
                    console.log("没有播放内容")
                }).always(function () {
                    "running" == e && o(), a(), $("#firstPage,#prevPage,#nextPage,#lastPage").removeClass(
                        "clickDisabled")
                })
...
            })
        }, s = function () {
            $("#playPause").unbind("click"), $("#firstPage,#prevPage,#nextPage,#lastPage").unbind("click"), n().unbind(
                "animationend")
        }, c = function () {
...
            })
        }, d = function () {
            $(document).unbind("keyup.left"), $(document).unbind("keyup.up"), $(document).unbind("keyup.space"), $(
                document).unbind("keyup.down"), $(document).unbind("keyup.right")
        };
    return {
        bindEvent: l,
        unbindEvent: s,
...
            originalEvent: KeyboardEvent
        })
    }), [].slice.call(["Msg", "Pic", "Applysign", "SigninLogo", "Guest", "Lottery", "Vote", "Mstching", "Shake",
            "Money", "Shakeprize", "Reward"]).forEach(function (e) {
...
            var n = t.cmd;
            n = n.replace("mcToggleControl", ""), n = n.substring(0, 1).toLowerCase() + n.substring(1), $("#" + n +
                ":visible").click()
        })
    }), [].slice.call(["danmu", "msg", "pic", "applysign", "signthreed", "lottery", "vote", "mstching", "shake",
            "money", "guest", "shakeprize", "redpack", "reward", "holdscreen"]).forEach(function (e) {
        e = "wall" + e + "Config";
...
        var t = e.noteType.substr(4).replace("Config", ""),
            n = '#wallcontrol li[wall-type="' + t + '"]',
            o = e.openState;
        "Y" == o ? ("applysign" == t && ("fullname" == e.displayType && (Hi.Wall.data.showFullName = !0), Hi.Load.module(
            "signinlogo", function () {
            $('#wallcontrol li[wall-type="signinlogo"]').show()
        })), Hi.Load.module(t, function () {
            $(n).show()
        })) : ("applysign" == t && (Hi.Wall.data.showFullName = !1, $('#wallcontrol li[wall-type="signinlogo"]').hide()),
            $(n).hide())
    });
    var n = function () {
...
                    }
                });
            var o = Hi.Activity.g(Hi.Activity.currentActivity),
                r = Hi.Activity.g(e);
...
        }, r = function () {
            var e = document;
            e.exitFullscreen ? e.exitFullscreen() : e.mozCancelFullScreen ? e.mozCancelFullScreen() : e.webkitCancelFullScreen &&
...
            var e = $.Deferred(),
                t = (new Hi.Anchor).get("wallType") || "msg",
                n = [t];
            return n.unshift("danmu"), console.log("loaded model", JSON.stringify(n)), Hi.Recurse.data(n, function (e,
                t) {
                Hi.Load.module(e, t)
            }).done(function () {
                e.resolve()
            }), e.promise()
        }, l = function (e) {
            var n = wallJson.styleName ? wallJson.styleName : "defaults",
                o = e.styleName ? e.styleName : "defaults";
            if (o !== n) return void window.location.reload();
            var r = e && e.logo ? Hi.String.dealUrl(e.logo) : "/images/placeholder.png",
                i = e && e.qrCode ? Hi.String.dealUrl(e.qrCode) : "/images/placeholder.png",
                a = e && e.title ? e.title : "",
                l = e && e.ruleDes ? e.ruleDes : "",
                s = e && e.sponsor ? e.sponsor : "",
                c = [];
            try {
                c = JSON.parse(s)
            } catch (e) {
                c.push({
                    img: "/images/wall/temp/hi-eg.png",
                    cont: "飞友科技基础技术部提供技术支持"
                })
            }
            var u = function () {
                $(".wall_logo img").attr("src", r).show(), $(".wall_logo img").attr("layer-src", r), i ? $(
                    ".qrcode img").attr("src", i).show() : $(".qrcode img").hide(), $("#wallHd").find(
                    ".wall_tit .wall-title-box").html(a), $("#wallNote").html($.base64.atob(l, !0));
                for (var o = "", s = 0, u = c.length; s < u; s++) {
                    var d = c[s];
                    o += '<div class="sponer-list"><span class="remove"><i class="fa fa-close"></i></span>', null != d.img &&
                        (o += '<img src="' + d.img + '">'), o += '<span class="sponer-cont">' + d.cont +
                        "</span></div>"
                }
...
                var m = tempGlobal[n].bgImg,
                    v = e && e.backgroundImg ? Hi.String.dealUrl(e.backgroundImg) : m,
                    p = "url(" + v + ")";
                $("body").css("background-image", p);
                try {
                    var g = JSON.parse(e.tempStyle);
                    g.fontColor ? ($("#wallHd").css("color", g.fontColor), $("#lottery-wall-block").css("color", g.fontColor)) :
                        $("#wallHd").css("color", ""), g && g.sponerAlign ? $("#wallcopyright").find(".sponer-order").css(
                        "text-align", g.sponerAlign) : $("#wallcopyright").find(".sponer-order").css("text-align",
                        "center"), 0 == $("#custom-style").length && $("body").append('<div id="custom-style"></div>'),
                        $("#custom-style").html(""), g && g.customBg ? $("#custom-style").html(
                        "<style>.custom-bg{background-color:" + g.customBg + ";}</style>") : $("#custom-style").html(
                        "<style>.custom-bg{background-color:#fff;}</style>")
                } catch (e) {
                    $("#wallcopyright").find(".sponer-order").css("text-align", "center")
                }
            }, d = e.qrText;
            "Y" == e.encodeFlag && d && (d = $.base64.atob(d, !0)), $("#qcord-win").find(".win-hed-cont").html(d),
                "Bound" == e.type ? $(".win-hed-bound").show() : $(".win-hed-bound").hide(), u()
        };
    Hi.Note.r(Hi.Note.type.UPDATE_GLOBAL, function (e) {
        "wall" == e.noteType && l(e)
...
                            var n = "run" == Hi.Control.state(),
                                o = template("qrcodeTemp", t);
...
            _this = $(this), _this.hasClass("esc_full") ? (_this.removeClass("esc_full"), r()) : (_this.addClass(
                "esc_full"), i())
...
            return Hi.Dc.query({
                flag: flag
            }).post("/web/wallcustom/read.html", function (t, n) {
...
                o = e.text,
                r = e.icon,
                i = e.index || $(".control-keys ul li").length - 1,
                a = $('<li class="tooltip" wall-type="reward"><a href="javascript:;"><i></i></a><div></div></li>');
            return a.attr("id", n), a.attr("wall-type", n), a.addClass("color-" + n), a.find("i").addClass(r), a.find(
                "div").text(o), $(".control-keys ul li").eq(i).after(a), t.resolve(), t.promise()
        };
    return {
        init: function () {
            var e = $.Deferred();
...
        var e = $.Deferred(),
            t = tempGlobal.defaults,
            n = $.extend(!0, t, tempGlobal[wallJson.styleName ? wallJson.styleName : "defaults"] || {});
...
            }
        }();
    console.group("-------Init start-------", startTime), Hi.Db.checkDb().then(Hi.LoadAnimate.set(20)).then(Hi.Db.initDb)
        .then(Hi.LoadAnimate.set(30)).then(t).then(Hi.LoadAnimate.set(40)).then(n.save).then(Hi.LoadAnimate.set(50)).then(
        Hi.Wall.loadModel).then(Hi.LoadAnimate.set(60)).then(Hi.Custom.init).then(n.note).then(Hi.LoadAnimate.set(70)).then(
        Hi.Wall.initDone).then(Hi.LoadAnimate.set(80)).then(Hi.LoadAnimate.set(90)).then(function () {
        Hi.Load.svg();
        var e = (new Hi.Anchor).get("wallType");
        e || (e = "msg"), $("#" + e + ":visible").length || $(".control-handle li:visible").length > 2 && (e = $(
            ".control-handle li:visible").eq(1).attr("id")), $("#" + e).click(), Hi.Tooltip.show(), "End" == wallJson.activeState ?
            layer.msg("活动已结束！") : "NoStart" == wallJson.activeState && layer.msg("活动未开始！"), setTimeout(function () {
